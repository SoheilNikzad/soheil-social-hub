...
const Index = () => {
  const socialLinks = [
    { name: "LinkedIn", nameFa: "لینکدین", url: "https://www.linkedin.com/in/soheilnikzad/" },
    { name: "GitHub", nameFa: "گیت‌هاب", url: "https://github.com/SoheilNikzad" },
    { name: "Telegram", nameFa: "تلگرام", url: "https://t.me/SoheilNikzad" },
    { name: "Instagram", nameFa: "اینستاگرام", url: "https://www.instagram.com/amuzanjirbaaf/" },
    { name: "Facebook", nameFa: "فیسبوک", url: "https://www.facebook.com/mirsoheilnikzad/" },
  ];
            ...
            <div className="space-y-3 mb-8">
              {socialLinks.map((link, index) => (
                ...
                >
                  <Button 
                    variant="outline" 
                    className="w-full md:w-3/4 lg:w-2/3 py-6 flex items-center justify-between bg-white hover:bg-gray-50 border border-gray-200 text-black"
                  >
